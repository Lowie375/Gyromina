...
exports.run = {
  execute(message, args, client) {
    const embed = new Discord.MessageEmbed()
      ...
      .setDescription(`*noun:*\n[1] A multipurpose Discord bot created by <@${botinfo.authorID}>, with contributions & support from <@${botinfo.contributorIDs[0]}> and <@${botinfo.contributorIDs[1]}> (Homura#5331), currently running v${botinfo.version} on ${client.guilds.cache.size} servers\n[2] \"${botinfo.tagline}\"`)
