...
module.exports.label = {
  ...
  "optionsdesc": "\• [difficulty/maximum]: Maximum number that the RNG could generate (up to [intlim]) or a preset difficulty (easy = 20, medium = 100, hard = 500, insane = 2500, master = 10000)",
  "exclusive": 0,
  "indev": 1,
  "deleted": 0
};